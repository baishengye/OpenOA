...
> 本文件是开发手册，命令可直接复制执行。模块作者指南见 [docs/ADDING_A_MODULE.md](docs/ADDING_A_MODULE.md)，踩坑速查见 [docs/TROUBLESHOOTING.md](docs/TROUBLESHOOTING.md)，App 三端构建细节见 [apps/oa/README.md](apps/oa/README.md)。
